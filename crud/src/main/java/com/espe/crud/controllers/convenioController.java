...
public class convenioController {
	...
	//@PostMapping(value = "/convenio/create2/{id}")
	//public convenio postConvenio2(@PathVariable("id") Long id,@RequestBody convenio Convenio) {
		//convenio _convenio = repository.postConvenio2(id, new convenio(Convenio.getId(), Convenio.getId_tip_conve(),
			//	Convenio.getFecha_ini(), Convenio.getFecha_fin(), Convenio.getEstado(), Convenio.getCode(),
				//Convenio.getUser_crea(), Convenio.getFecha_crea(), Convenio.getUsuario_mod(), Convenio.getFecha_mod()));
	//	return _convenio;
	//}
