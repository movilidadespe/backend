...
public class solicitudesController {
	  ...
	  @RequestMapping(value = "/solicitud", method = RequestMethod.GET)
	    ...
	    public ResponseEntity<solicitudes> create(@Valid @RequestBody solicitudes solicitudes) {
		  ...
		  @RequestMapping(value = "/consumir", method = RequestMethod.GET)
		  public ResponseEntity<?> getRequestInformation()
				throws SQLException {
			...
			try {
				...
				// information passed
				String webService = "https://aplicaciones.espe.edu.ec:8443/authentication/api/query/ced=1718552381&auth=ba82e1071cd1ea9669a62f24213ba4a4.cf3df0e97b7a4cc68aeaab8d6bbb9691?fbclid=IwAR3D3xBT2UZEsNo04ZeKSW4CIdYtB1tVdC0X5QXRxWCDIlXBw2WxXLGkymc";
